...
class RelatedProductsWidget extends StatelessWidget {
  ...
  const RelatedProductsWidget({super.key, required this.currentProduct});
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () {
                  context.push('/related_products', extra: currentProduct);
                },
                child: Row(
                  children: const [
                    Text(
        ...
        relatedProducts.isEmpty
            ? const Padding(
                ...
                child: Center(child: Text('No related products available')),
              )
            : SizedBox(
                height: 280,
